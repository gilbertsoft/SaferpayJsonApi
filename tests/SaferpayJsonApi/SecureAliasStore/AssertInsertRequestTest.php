...
use Gilbertsoft\SaferPayApi\SecureAliasStore\AssertInsertRequest;
...
class AssertInsertRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSuccessfulResponse()
    {
        ...
        $this->assertInstanceOf('Gilbertsoft\SaferPayApi\SecureAliasStore\AssertInsertResponse', $response);
    }
    ...
    public function getResponseMock($successful)
    {
        ...
        if ($successful) {
            $content = $this->getFakedApiResponse('Gilbertsoft\SaferPayApi\SecureAliasStore\AssertInsertResponse');
        } else {
